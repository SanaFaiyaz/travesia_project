...
@endif
        ...
        <div class="hotel-border ">
            ...
            <img class="image-size" src="data:image/jpeg;base64,{{ base64_encode($place->image) }}">

            <h3 style="font-size: 70px;">{{ $place->name }}</h3>

            <p style="font-size: 25px;">{{ $place->city }}</p>

            <p style="font-size: 25px;">{{ $place->hours }} Hours </p>

            <p style="font-size: 25px;">{{ $place->amount }} Rs. </p>

            <p style="font-size: 25px;"> Description : {{ $place->description }} </p>
